...
function requestError(status) {
  return standaloneChrome.render({
    title: "Request failed · Pages",
    kicker: "Request failed",
    heading: status < 500 ? "Request could not be read" : "Pages could not complete this request",
    bodyHtml: status < 500 ? "<p>Check the request and try again.</p>" : "<p>Please try again shortly.</p>",
    assetsBase: "/shell-assets/flag",
    cta: { href: "/admin", label: "Back to Pages" },
  });
}

module.exports = { notFound, requestError };
