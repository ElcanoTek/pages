...
function executionRequirements(sources, mode, { slug = null } = {}) {
...
function managedPrompt({ slug, instructions, schemaSha256, publish, recurring, sources = null }) {
  ...
  return [
    ...
    JSON.stringify(executionRequirements(sources, "managed_data", { slug })),
    ...
    ...(recurring ? [RECURRING_ROSTER_CLAUSE] : []),
...
async function prepare({
  ...
  return {
    ...
    execution_requirements: executionRequirements(sources, mode, { slug }),
