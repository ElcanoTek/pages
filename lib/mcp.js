...
const INSTRUCTIONS = [
  ...
  "For HTML saved in a workspace file or over 20,000 UTF-8 bytes, never paste the whole file into deploy_page/update_page or pass a path, shell expression or placeholder. " + fileUploadGuidance("page"),
