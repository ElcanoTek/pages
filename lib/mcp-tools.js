...
const { normalizeSourceAsOf } = require("./page-data");
...
const TOOLS = {
  ...
  get_page_data: {
    ...
    inputSchema: z.object({ slug: Slug, include_data: z.boolean().optional().describe("Default true. False returns the schema, hashes, profile, live state and coverage without envelope.data; use for refresh preflight when full data would be truncated.") }).strict(),
    outputSchema: z
      .object({
        page: PageSchema,
