...
const { normalizeSourceAsOf, coverageProfile } = require("./page-data");
...
const PAGE_DATA_MODE_FIELDS = Object.freeze({
  full: {
    ...
    forbidden: ["coverage_profile", "exports", "next_step"],
  },
  summary: {
  ...
  export: {
    ...
    forbidden: ["schema", "version", "version_is_live", "page_is_live", "urls", "data_profile", "data_omitted", "coverage_profile", "freshness"],
  },
});
...
function pageDataSummary(result) {
  ...
  return {
    ...
    coverage_profile: coverageProfile(result.data_profile),
