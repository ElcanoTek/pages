...
test("automatic updates require an established predecessor and reviewed pending migrations", () => {
  ...
  assert.throws(() => checkCompatibility(["001_base.sql"], ["002_added.sql", "003_renamed.sql"], policy), /manual upgrade.*003_renamed/);
  assert.throws(() => checkCompatibility(["001_base.sql"], ["004_unknown.sql"], policy), /manual upgrade.*004_unknown/);
